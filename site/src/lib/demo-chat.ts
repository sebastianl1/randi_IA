...
const es: L10n = {
  ...
  limit: 'Llegaste al límite gratuito de hoy. Prueba Pro (sin límites) o vuelve mañana.',
  ...
  msgsL: 'mensajes',
  tokL: '≈ tokens',
  sugg: ['Explícame qué es un LLM en términos simples', 'Escribe un script de Python para leer un CSV', 'Dame 3 ideas para presentar un proyecto', 'Resúmeme qué es Ollama', 'Compara Qwen y Llama', '¿Cómo uso RANDI en Android?', 'Explícame qué es el contexto de un modelo', 'Genera un cuento corto'],
  suggTitle: '¿Sobre qué quieres hablar?',
  copyAll: 'Copiar chat',
  today: 'hoy',
  empty: 'El modelo devolvió una respuesta vacía. Prueba con otro modelo.',
  soon: 'Próximamente',
